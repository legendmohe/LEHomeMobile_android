...
//    private static final float MIN_AMPLITUDE_TO_DRAW = 3000.0f;
     ...
     */
    public synchronized void updateAudioData(short[] buffer, int len) {
        short[] newBuffer;
    ...
    private void drawWaveform(Canvas canvas) {
        ...
        for (short[] buffer : mAudioData) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                float y;
//                if (Math.abs(sample) < MIN_AMPLITUDE_TO_DRAW) {
//                    y = centerY;
//                } else {
                y = (sample / MAX_AMPLITUDE_TO_DRAW) * centerY + centerY;
//                }
